...
Even though it is reflecting darkness it is still need of a boost.  I found a setting of `1.5` in **Exposure Compensation** got the lighting back to where it was bright like day.
...
Add a **Point Light** and place it just above the fire pit.
